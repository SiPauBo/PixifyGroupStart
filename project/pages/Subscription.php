    ...
    <div class="container">
      <div class="row">
        <div class="col">
          ...
          <p><a href="#" class="text-secondary">Team</a></p>
        </div>
        <div class="col">
          <p class="fw-bold">Licensing</p>
          <p><a href="#" class="text-secondary">Information</a></p>
          <p><a href="#" class="text-secondary">Terms of Use</a></p>
        </div>
      </div>
      <hr>
      <p class="mt-3">&copy; 2024 All rights reserved PIXIFY</p>
    </div>
  </footer>
